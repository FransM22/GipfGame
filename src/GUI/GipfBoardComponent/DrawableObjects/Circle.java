...
public class Circle extends DrawableObject {
    Set<Position> circlePositions;
    int size;
    Color fillColor;
    Color borderColor;
    Stroke strokeStyle;

    Circle(Graphics2D g2, GipfBoardComponent gipfBoardComponent, Set circlePositions, int size, Color fillColor, Color borderColor, Stroke strokeStyle) {
